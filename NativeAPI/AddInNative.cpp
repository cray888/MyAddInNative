...
static const wchar_t *g_PropNames[] = {L"IsEnabled", L"IsTimerPresent"};
static const wchar_t *g_MethodNames[] = {L"Enable", L"Disable", L"ShowInStatusLine", 
        L"StartTimer", L"StopTimer", L"LoadPicture", L"ShowMessageBox", L"Loopback"};

static const wchar_t *g_PropNamesRu[] = {L"Включен", L"ЕстьТаймер"};
static const wchar_t *g_MethodNamesRu[] = {L"Включить", L"Выключить", L"ПоказатьВСтрокеСтатуса", 
        L"СтартТаймер", L"СтопТаймер", L"ЗагрузитьКартинку", L"ПоказатьСообщение", L"Петля"};
