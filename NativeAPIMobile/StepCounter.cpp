...
CStepCounter::CStepCounter() : isRun(false), m_iCnt(NULL),
...
void CStepCounter::setIConnect(IAddInDefBaseEx* piConnect)
{
    ...
    if (m_iCnt) 
    {
        ...
        motionRecorder = ref new CStepCounterRecorder(m_iCnt, &sharedData);
            
#else //MOBILE_PLATFORM_WINRT
    
        motionRecorder = new CStepCounterRecorder(m_iCnt, &sharedData);
